  ...
  return (
    ...
    >
      ...
      <div className={classes.paper}>
        <div style={{ ...props.mainStyle.header }}>L</div>
        <div style={{ ...props.mainStyle.subHeader }}>
          fill out these answers so we can provide you with best service
        </div>
          ...
          <Grid container spacing={2}>
            ...
            <Grid item xs={12}>
              <TextField
                ...
                fullWidth
                id="marketing"
                label="Do you currently have a marketing team?"
                name="marketing"
            ...
            <Grid item xs>
              <TextField
                ...
                fullWidth
                name="Message"
                label="How many new customers can you take in each month?"
                type="textbox"
                rowsMax="4"
              />
            </Grid>
